...
class TransFormer(nn.Module):
    def __init__(self, n_users, n_times, n_apps, hidden_dim, dim, seq_length):
    ...
    def forward(self, users, times, app_seq):
        ...
        input_vector = torch.cat([user_vector.repeat(1, self.seq_length, 1), time_vector.repeat(1, self.seq_length, 1), app_seq_vector], axis=2)
